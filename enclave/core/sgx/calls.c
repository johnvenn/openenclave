...
//uint64_t arg_in = arg2;
    ...
    *output_arg2 = 0;
    ...
    if ((func == OE_ECALL_INIT_ENCLAVE) && NULL != pcl_entry)
	{
		...
		// TO DO: please add pcl_entry function here,
		// before adding the actual action, please first comment 
		// it out to do the regression test to make sure
		// the code modified for pcl doesn't affect other features
		//pcl_entry(arg, arg_list); // need to add arg list here
